...
if [ -f "/opt/agent-newsletter-digest/scripts/email/finalize-newsletter-digest.sh" ]; then
  exec /opt/agent-newsletter-digest/scripts/email/finalize-newsletter-digest.sh "$@"
fi
