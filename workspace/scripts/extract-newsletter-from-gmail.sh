...
if [ -f "/opt/agent-email-digest/scripts/email/extract-newsletter-from-gmail.mjs" ]; then
  exec /opt/agent-email-digest/scripts/email/extract-newsletter-from-gmail.mjs "$@"
fi
