...
if [ -f "/opt/agent-newsletter-digest/scripts/email/render-newsletter-digest.mjs" ]; then
  exec /opt/agent-newsletter-digest/scripts/email/render-newsletter-digest.mjs "$@"
fi
